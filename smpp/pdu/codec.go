...
func Decode(r io.Reader) (Body, error) {
	...
	case AlertNotificationID:
		// TODO(donovansolms): Implement AlertNotification.
	...
	case CancelSMID:
		// TODO(donovansolms): Implement CancelSM.
	case CancelSMRespID:
		// TODO(donovansolms): Implement CancelSMResp.
	case DataSMID:
		// TODO(donovansolms): Implement DataSM.
	case DataSMRespID:
		// TODO(donovansolms): Implement DataSMResp.
	case DeliverSMID:
	...
	case OutbindID:
		// TODO(donovansolms): Implement Outbind.
	case QuerySMID:
		return decodeFields(newQuerySM(hdr), b)
	case QuerySMRespID:
		return decodeFields(newQuerySMResp(hdr), b)
	case ReplaceSMID:
		// TODO(donovansolms): Implement ReplaceSM.
	case ReplaceSMRespID:
		// TODO(donovansolms): Implement ReplaceSMResp.
	case SubmitMultiID:
